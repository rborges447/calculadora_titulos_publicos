...
@router.get("/ltn/detalhes", response_model=VencimentosResponse, summary="Vencimentos LTN (detalhado)")
...
@router.get("/lft/detalhes", response_model=VencimentosResponse, summary="Vencimentos LFT (detalhado)")
...
@router.get("/ntnb/detalhes", response_model=VencimentosResponse, summary="Vencimentos NTNB (detalhado)")
...
@router.get("/ntnf/detalhes", response_model=VencimentosResponse, summary="Vencimentos NTNF (detalhado)")
...
@router.get("/todos/detalhes", response_model=TodosVencimentosResponse, summary="Todos os vencimentos (detalhado)")
