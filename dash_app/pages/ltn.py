...
def layout():
    return dbc.Container(
        [
            ...
            html.H2("LTN - Letra do Tesouro Nacional"),
            ...
            dbc.Card(
                dbc.CardBody(
                    [
                        ...
                        html.Div(id="ltn-tabela-container"),
                    ]
                ),
            ),
        ],
...
def atualizar_taxa_callback(timestamp, data_atual, active_cell, carteira_id, dados_originais, tipo, di, dias):
    ...
    if carteira_id:
        if tipo == "taxa":
            ...
            ok, resultado = atualizar_premio_di("ltn", carteira_id, vencimento_raw, taxa_float, float(di))
        else:
            return data_atual, carteira_id, dados_originais or []
    ...
    try:
        ...
        if tipo == "taxa":
            ...
            ok_atualizar, resultado_atualizar = atualizar_premio_di("ltn", novo_id, vencimento_raw, taxa_float, float(di))
        else:
